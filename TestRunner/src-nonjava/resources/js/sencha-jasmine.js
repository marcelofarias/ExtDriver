...
(function () {
    ...
    jasmine.Spec = function () {
        ...
        this.id = jasmine.hashString(this.description, this.suite.id);
    };
...
(function () {
    ...
    jasmine.Suite = function () {
        ...
        this.id = jasmine.hashString(this.description, parentSuite ? parentSuite.id : 0);
    };
